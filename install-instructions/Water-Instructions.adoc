...
Computational Software Packages (CSPs) have revolutionized the way we do science. Compared to traditional methods of experimentation, CSPs cost less and present less hazards. With such benefits, it seems that the utiilization of CSPs would be an integral component of any science-based education. 
